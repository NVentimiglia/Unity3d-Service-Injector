...
namespace Foundation.Ioc
{
    internal static class ReflectionExtensions
    {
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        internal static bool HasAttribute<T>(MemberInfo m) where T : Attribute
        {
#if UNITY_WSA
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        internal static T GetAttribute<T>(MemberInfo m) where T : Attribute
        {
            return m.GetCustomAttributes(typeof(T), true).FirstOrDefault() as T;
        }
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        internal static T GetAttribute<T>(Type m) where T : Attribute
        {
#if UNITY_WSA
        ...
        /// </summary>
        /// <returns></returns>
        internal static void SetMemberValue(MemberInfo member, object instance, object value)
        {
            if (member is MethodInfo)
            {
